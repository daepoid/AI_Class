...
//      }
//      for (i = 0; i < sz3; i++) {
//        temp = learning_rate * Delta3[i];
//        b3[i] = b3[i] - temp;
//      }
//      for (i = 0; i < sz2; i++) {
//        temp = learning_rate * Delta2[i];
//        b2[i] = b2[i] - temp;
//      }
//      for (i = 0; i < sz1; i++) {
//        temp = learning_rate * Delta1[i];
//        b1[i] = b1[i] - temp;
//      }
//    }
...
//    if (index % 10000 == 0) {
//      printf("Traing data loading. train_set_index = %d\n", index);
//    }
...
//    if (index % 2000 == 0) {
//      printf("test data loading. test_data_index = %d\n", index);
//    }
