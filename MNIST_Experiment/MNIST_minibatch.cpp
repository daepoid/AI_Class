...
int main() {
  ...
  ////////////////////////////////////////////////////
  minibatch_size = minibatch_size / 2; // SIZE_MINIBATCH / 2
  printf("Init Parameter\n");
  init_parameters();
  printf("Do Train\n");
  Do_train();
  ...
  ////////////////////////////////////////////////////
  minibatch_size = minibatch_size / 2; // SIZE_MINIBATCH / 4
  printf("Init Parameter\n");
  init_parameters();
  printf("Do Train\n");
  Do_train();
  ...
  ////////////////////////////////////////////////////
  minibatch_size = minibatch_size / 2; // SIZE_MINIBATCH / 8
  printf("Init Parameter\n");
  init_parameters();
  printf("Do Train\n");
  Do_train();
  ...
  ////////////////////////////////////////////////////
  minibatch_size = SIZE_MINIBATCH / 4;
  learning_rate = 0.08;
  printf("Init Parameter\n");
  init_parameters();
  printf("Do Train\n");
